...
export interface SpeechSettingsLoadedMessage {
  ...
  settings: {
    ...
    provider: "browser" | "azure" | "openaiCompatible"
    hasAzureKey: boolean
...
export interface SaveSpeechSecretMessage {
  type: "saveSpeechSecret"
  secretKey: "azureApiKey" | "openaiCompatibleApiKey"
  value: string
}

export interface ClearSpeechSecretMessage {
  type: "clearSpeechSecret"
  secretKey: "azureApiKey" | "openaiCompatibleApiKey"
}
...
export type WebviewMessage =
  ...
  | UpdateConfigMessage
  | SaveSpeechSecretMessage
  | ClearSpeechSecretMessage
