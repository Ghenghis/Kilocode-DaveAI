# Phase 01 — Install and Workspace Integrity

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 01.

## Goal
Complete the work specific to install and workspace integrity without expanding scope beyond what the evidence requires.
