# Phase 04 — Build and Bundle Integrity

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 04.

## Goal
Complete the work specific to build and bundle integrity without expanding scope beyond what the evidence requires.
