# Phase 06 — UI Wiring Validation

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 06.

## Goal

Complete the work specific to ui wiring validation without expanding scope beyond what the evidence requires.
