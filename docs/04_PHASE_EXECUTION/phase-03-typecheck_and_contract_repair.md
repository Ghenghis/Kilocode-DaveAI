# Phase 03 — Typecheck and Contract Repair

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 03.

## Goal

Complete the work specific to typecheck and contract repair without expanding scope beyond what the evidence requires.
