# Phase 00 — Restore and Canonicalize

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 00.

## Goal

Complete the work specific to restore and canonicalize without expanding scope beyond what the evidence requires.
