# Phase 02 — Lint and Static Analysis

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 02.

## Goal
Complete the work specific to lint and static analysis without expanding scope beyond what the evidence requires.
