# Phase 08 — Playwright and Visual E2E

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 08.

## Goal
Complete the work specific to playwright and visual e2e without expanding scope beyond what the evidence requires.
