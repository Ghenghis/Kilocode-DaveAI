# Phase 05 — Unit and Integration Tests

This phase document defines the exact goal, inputs, commands, evidence, stop rules, and pass criteria for Phase 05.

## Goal
Complete the work specific to unit and integration tests without expanding scope beyond what the evidence requires.
